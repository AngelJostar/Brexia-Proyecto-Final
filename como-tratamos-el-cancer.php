    ...
    <section id="site-wrapper">
        ...
        <?php include_once 'includes/templates/header.php';?>
            ...
            <div class="contenedor-4 justificar-texto">
                ...
                <h2 class="formato-h2 centrar-texto paddingtop-50 ">Enfoque Humano centrado en el paciente</h2>
                <p>
                    Un diagnóstico de cáncer puede hacerle sentir diversas y profundas emociones como miedo a la muerte, ira, esperanza, culpa, negación, tristeza, soledad o ansiedad. Estas emociones son reacciones naturales ante un cambio importante. Explora el enlace a
